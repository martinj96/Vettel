namespace Transpo.Infrastructure.Data.Migrations
{
    ...
    public partial class precisions : DbMigration
    {
        ...
        {
            AlterColumn("dbo.CriticalPoints", "Longitude", c => c.Decimal(nullable: false, precision: 18, scale: 2));
            AlterColumn("dbo.CriticalPoints", "Latitude", c => c.Decimal(nullable: false, precision: 18, scale: 2));
        }
    }
}
