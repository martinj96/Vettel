...
namespace Transpo.Mobile.iOS
{
	public class SearchPageRenderer : PageRenderer
	{
		...
		public override void ViewDidLoad()
		{
			...
			//SetConstraintsForFromButton();
			//SetConstraintsForToButton();
		}

		void SetConstraintsForFromButton()
		{
			var left = fromLocationButton.LeftAnchor.ConstraintEqualTo(View.LeftAnchor);
			var right = fromLocationButton.RightAnchor.ConstraintEqualTo(View.RightAnchor);
			//var top = fromLocationButton.TopAnchor.ConstraintEqualTo(View.TopAnchor);
			//var height = fromLocationButton.HeightAnchor.ConstraintEqualTo(View.Frame.Height);
		...
		void SetConstraintsForToButton()
		{
			var left = toLocationButton.LeftAnchor.ConstraintEqualTo(View.LeftAnchor);
			var right = toLocationButton.RightAnchor.ConstraintEqualTo(View.RightAnchor);
			//var top = toLocationButton.TopAnchor.ConstraintEqualTo(View.TopAnchor);
			//var height = toLocationButton.HeightAnchor.ConstraintEqualTo(View.Frame.Height);
